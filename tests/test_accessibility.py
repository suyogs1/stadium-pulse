...
def test_semantic_headings(app_source):
    ...
    assert "st.title(" in app_source, "Main page title (H1) is missing."
    assert "st.header(" in app_source or "st.subheader(" in app_source, "Section headers (H2/H3) are missing."
