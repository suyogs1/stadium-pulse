...
PLAYBOOK_PHASES = {
    ...
    2: {
        ...
        "desc": "Calculating venue-wide Load/Capacity distribution.",
        "icon": "📊",
    },
    3: {
    ...
    4: {
        ...
        "desc": "Engaging Optimizer agent clusters & Gemini Flash AI.",
        "icon": "🧠",
    },
    5: {
    ...
    6: {
        "name": "Crowd Redistribution",
        "desc": "Dispatching alerts & monitoring the resolution loop.",
        "icon": "🔄",
    },
}
